...
export default function PokemonDetail() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 capitalize text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white py-5">
        ⚡ {pokemon.name}
      </h1>
          ...
          <ul className="space-y-2 mb-4">
            {pokemon.stats.map((stat: PokemonStat, index: number) => (
              <li key={index} className="flex items-center">
                ...
                <span className="w-10 text-right mr-2">
                  {stat.base_stat}
                </span>
